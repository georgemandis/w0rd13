...
Copy `.env.example` to `.env` if you want analytics. Everything else works without it.

More in [docs/w0rd13.md](docs/w0rd13.md): URL parameters, how puzzles are generated, where the word lists come from, and a hidden second game.
